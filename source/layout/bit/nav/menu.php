<li class="mdc-list-item" role="menuitem">
	...
	<div class="item-content d-flex align-items-start flex-column justify-content-center">
		<h6 class="item-subject font-weight-normal" onClick="window.location.href='/update-profile';">Update Profile</h6>
	</div>
</li>
...
<li class="mdc-list-item" role="menuitem">
	...
	<div class="item-content d-flex align-items-start flex-column justify-content-center">
		<h6 class="item-subject font-weight-normal" onClick="window.location.href='/change-password';">Change Password</h6>
	</div>
</li>
<li class="mdc-list-item" role="menuitem">
